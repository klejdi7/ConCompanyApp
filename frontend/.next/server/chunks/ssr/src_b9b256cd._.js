...
function EmployeesPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            let res;
            if (isEdit) {
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/employees/${modalEmployee.id}`, modalEmployee);
            } else {
                res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/employees", modalEmployee);
            }
            if (res.status === 200 || res.status === 201) {
                ...
                if (modalEl) {
                    const modal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bootstrap$2f$dist$2f$js$2f$bootstrap$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Modal"].getOrCreateInstance(modalEl);
                    modal.hide();
                }
            } else {
...
//# sourceMappingURL=src_b9b256cd._.js.map