...
;
;
function EmployeeModal({ employee, isEdit = false, onSubmit, buttonText = "Add Employee", className = "btn btn-primary mb-3" }) {
...
function EmployeesPage() {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/employees/${id}`);
            fetchEmployees();
        } catch (err) {
            console.error(err);
...
//# sourceMappingURL=_517602e0._.js.map