...
function ProjectsPage() {
    ...
    const fetchProjects = async ()=>{
        if (!token) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:4000/projects", {
                headers: {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (isEdit) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:4000/projects/${modalProject.id}`, modalProject, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:4000/projects", modalProject, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:4000/projects/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__310d54f1._.js.map