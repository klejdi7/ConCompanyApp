...
"[project]/src/components/EmployeeModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EmployeeModal({ employee, mode = "add", onSubmit, buttonText, className = "btn btn-primary mb-3" }) {
    ...
    const [modalEmployee, setModalEmployee] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(employee || {
        id: 0,
        firstName: "",
        lastName: "",
        rate: 0,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$EmployeeModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/EmployeeModal.tsx [app-ssr] (ecmascript)");
...
function EmployeesPage() {
    ...
    const { user, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthGuard$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthGuard"])();
    ...
    const fetchEmployees = async ()=>{
        if (!token) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/api/employees");
    ...
    const handleAction = async (employee, mode)=>{
        try {
            if (mode === "add" && employee) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/employees", employee);
            }
            if (mode === "edit" && employee) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/employees/${employee.id}`, employee);
            }
            if (mode === "delete" && employee) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/employees/${employee.id}`);
            }
...
//# sourceMappingURL=src_c5205e80._.js.map