...
function EmployeeDetailPage() {
    ...
    const handleAction = async (emp, mode)=>{
        ...
        try {
            if (mode === "edit") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/employees/${id}`, emp);
                await fetchDetails();
            } else if (mode === "delete") {
...
//# sourceMappingURL=src_65d644e1._.js.map