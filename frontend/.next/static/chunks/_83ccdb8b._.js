...
function EmployeeModal(param) {
    let { employee, isEdit = false, onSubmit, buttonText = "Add Employee", className = "btn btn-primary mb-3" } = param;
    _s();
...
//# sourceMappingURL=_83ccdb8b._.js.map