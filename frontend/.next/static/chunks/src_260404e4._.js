...
function EmployeeDetailPage() {
    ...
    const handleAction = async (emp, mode)=>{
        ...
        try {
            if (mode === "edit") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("/api/employees/".concat(id), emp);
                await fetchDetails();
            } else if (mode === "delete") {
...
//# sourceMappingURL=src_260404e4._.js.map