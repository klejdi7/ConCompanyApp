...
/*!
  ...
  */ !function(t, e) {
    ...
    }, i = "transitionend", n = (t)=>(t && window.CSS && window.CSS.escape && (t = t.replace(/#([^\s"#']+)/g, (t, e)=>"#".concat(CSS.escape(e)))), t), s = (t)=>null == t ? "".concat(t) : Object.prototype.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase(), o = (t)=>{
    ...
    }, V = ".bs.alert", K = "close".concat(V), Q = "closed".concat(V);
    class X extends B {
        static get NAME() {
            return "alert";
        }
    ...
    const G = ".bs.swipe", J = "touchstart".concat(G), Z = "touchmove".concat(G), tt = "touchend".concat(G), et = "pointerdown".concat(G), it = "pointerup".concat(G), nt = {
        endCallback: null,
        leftCallback: null,
        rightCallback: null
    }, st = {
    ...
    const rt = ".bs.carousel", at = ".data-api", lt = "ArrowLeft", ct = "ArrowRight", ht = "next", dt = "prev", ut = "left", ft = "right", pt = "slide".concat(rt), mt = "slid".concat(rt), gt = "keydown".concat(rt), _t = "mouseenter".concat(rt), bt = "mouseleave".concat(rt), vt = "dragstart".concat(rt), yt = "load".concat(rt).concat(at), wt = "click".concat(rt).concat(at), At = "carousel", Et = "active", Tt = ".active", Ct = ".carousel-item", Ot = Tt + Ct, xt = {
        [lt]: ft,
        [ct]: ut
    }, kt = {
        interval: 5e3,
    ...
    const Dt = ".bs.collapse", $t = "show".concat(Dt), It = "shown".concat(Dt), Nt = "hide".concat(Dt), Pt = "hidden".concat(Dt), jt = "click".concat(Dt, ".data-api"), Mt = "show", Ft = "collapse", Ht = "collapsing", Wt = ":scope .".concat(Ft, " .").concat(Ft), Bt = '[data-bs-toggle="collapse"]', zt = {
        parent: null,
        toggle: !0
    }, Rt = {
        parent: "(null|element)",
    ...
    const Ai = Object.freeze(Object.defineProperty({
        ...
        value: "Module"
    })), Ei = "dropdown", Ti = ".bs.dropdown", Ci = ".data-api", Oi = "ArrowUp", xi = "ArrowDown", ki = "hide".concat(Ti), Li = "hidden".concat(Ti), Si = "show".concat(Ti), Di = "shown".concat(Ti), $i = "click".concat(Ti).concat(Ci), Ii = "keydown".concat(Ti).concat(Ci), Ni = "keyup".concat(Ti).concat(Ci), Pi = "show", ji = '[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)', Mi = "".concat(ji, ".").concat(Pi), Fi = ".dropdown-menu", Hi = m() ? "top-end" : "top-start", Wi = m() ? "top-start" : "top-end", Bi = m() ? "bottom-end" : "bottom-start", zi = m() ? "bottom-start" : "bottom-end", Ri = m() ? "left-start" : "right-start", qi = m() ? "right-start" : "left-start", Vi = {
        autoClose: !0,
    ...
    const Xi = "backdrop", Yi = "show", Ui = "mousedown.bs.".concat(Xi), Gi = {
    ...
    const tn = ".bs.focustrap", en = "focusin".concat(tn), nn = "keydown.tab".concat(tn), sn = "backward", on = {
        autofocus: !0,
        trapElement: null
    }, rn = {
        autofocus: "boolean",
    ...
    const fn = ".bs.modal", pn = "hide".concat(fn), mn = "hidePrevented".concat(fn), gn = "hidden".concat(fn), _n = "show".concat(fn), bn = "shown".concat(fn), vn = "resize".concat(fn), yn = "click.dismiss".concat(fn), wn = "mousedown.dismiss".concat(fn), An = "keydown.dismiss".concat(fn), En = "click".concat(fn, ".data-api"), Tn = "modal-open", Cn = "show", On = "modal-static", xn = {
        backdrop: !0,
        focus: !0,
        keyboard: !0
    }, kn = {
    ...
    const Sn = ".bs.offcanvas", Dn = ".data-api", $n = "load".concat(Sn).concat(Dn), In = "show", Nn = "showing", Pn = "hiding", jn = ".offcanvas.show", Mn = "show".concat(Sn), Fn = "shown".concat(Sn), Hn = "hide".concat(Sn), Wn = "hidePrevented".concat(Sn), Bn = "hidden".concat(Sn), zn = "resize".concat(Sn), Rn = "click".concat(Sn).concat(Dn), qn = "keydown.dismiss".concat(Sn), Vn = {
        backdrop: !0,
        keyboard: !0,
        scroll: !1
    }, Kn = {
    ...
    g(vs);
    const ys = ".bs.scrollspy", ws = "activate".concat(ys), As = "click".concat(ys), Es = "load".concat(ys, ".data-api"), Ts = "active", Cs = "[href]", Os = ".nav-link", xs = "".concat(Os, ", .nav-item > ").concat(Os, ", .list-group-item"), ks = {
        offset: null,
    ...
    const Ds = ".bs.tab", $s = "hide".concat(Ds), Is = "hidden".concat(Ds), Ns = "show".concat(Ds), Ps = "shown".concat(Ds), js = "click".concat(Ds), Ms = "keydown".concat(Ds), Fs = "load".concat(Ds), Hs = "ArrowLeft", Ws = "ArrowRight", Bs = "ArrowUp", zs = "ArrowDown", Rs = "Home", qs = "End", Vs = "active", Ks = "fade", Qs = "show", Xs = ".dropdown-toggle", Ys = ":not(".concat(Xs, ")"), Us = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', Gs = ".nav-link".concat(Ys, ", .list-group-item").concat(Ys, ', [role="tab"]').concat(Ys, ", ").concat(Us), Js = ".".concat(Vs, '[data-bs-toggle="tab"], .').concat(Vs, '[data-bs-toggle="pill"], .').concat(Vs, '[data-bs-toggle="list"]');
    class Zs extends B {
        static get NAME() {
            return "tab";
        }
    ...
    const to = ".bs.toast", eo = "mouseover".concat(to), io = "mouseout".concat(to), no = "focusin".concat(to), so = "focusout".concat(to), oo = "hide".concat(to), ro = "hidden".concat(to), ao = "show".concat(to), lo = "shown".concat(to), co = "hide", ho = "show", uo = "showing", fo = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, po = {
