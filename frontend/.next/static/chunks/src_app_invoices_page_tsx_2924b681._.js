...
function InvoicesPage() {
    ...
    const fetchInvoices = async ()=>{
        if (!token) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:4000/invoices", {
                headers: {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (isEdit) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("http://localhost:4000/invoices/".concat(modalInvoice.id), modalInvoice, {
                    headers: {
                        Authorization: "Bearer ".concat(token)
                    }
                });
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:4000/invoices", modalInvoice, {
                    headers: {
                        Authorization: "Bearer ".concat(token)
                    }
                });
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete("http://localhost:4000/invoices/".concat(id), {
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
            });
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        type: "date",
                                        className: "form-control mb-2",
                                        value: (modalInvoice === null || modalInvoice === void 0 ? void 0 : modalInvoice.date) || "",
                                        onChange: (e)=>setModalInvoice((prev)=>({
                                                    ...prev,
                                                    date: e.target.value
                                                })),
...
_s(InvoicesPage, "aNG+Qf7G1PirMIqPIT1iwJB6l+Q=", false, function() {
    return [
...
//# sourceMappingURL=src_app_invoices_page_tsx_2924b681._.js.map